package com.icha.modulsebelas.view
...
import com.icha.modulsebelas.R
...
class PhotoListAdapter(var photos: ArrayList<Photo>) : RecyclerView.Adapter<PhotoListAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        fun bind(photos: Photo) {
            ...
            itemView.namaurl.text = photos.iniurl
            itemView.setOnClickListener {
                    view -> Toast.makeText(itemView.context,"Hello", Toast.LENGTH_LONG).show()
            }
